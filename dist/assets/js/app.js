...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).foundation(); // shows and hides filtered items

jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filter-simple-button").click(function () {
  var value = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('data-filter');

  if (value === "all") {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.filter-simple-item').show('1000');
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filter-simple-item").not('.' + value).hide('3000');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.filter-simple-item').filter('.' + value).show('3000');
  }
